package com.test.zysnail.www.ui.knowledge_lib;
...
import com.test.zysnail.www.utils.Utils;

/**
 * Created by zy01060 on 2018/1/22.
 * 软键盘弹出和隐藏监听类
 */
...
public class AndroidBug5497Workaround {
    ...
    private void possiblyResizeChildOfContent(Activity activity, OnInputMethodManagerLinstener linstener) {
        ...
        if (usableHeightNow != usableHeightPrevious) {
            int sta = Utils.getStatusHeight(activity);
            ...
            if (heightDifference > (usableHeightSansKeyboard / 4)) {
                ...
                int a = Utils.getNavigationBarHeight(activity);
    ...
    private int computeUsableHeight(Activity activity) {
        ...
        int sta = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            sta = Utils.getStatusHeight(activity);
        }
